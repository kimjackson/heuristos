	...
	var saver = new HSaver(
			...
			if ((window.opener.location.pathname==("/dos/addrelationship.html"))|| (window.opener.location.pathname==("/dos/edit-annotation.html")) || (window.opener.location.pathname==("/dos/edit-annotation-t.html"))) {
				if(window.opener.document.getElementById("results") ){
					//var innerHTML = "";
					//innerHTML += "<img src=/dos/img/reftype/"+r.getRecordType().getID()+".gif> ";
					//innerHTML += "<a href=# onclick=\"setLinkedRecord("+r.getID()+", this.innerHTML); return false;\">" + r.getTitle() + "</a><br/>";
					//window.opener.document.getElementById("results").innerHTML = innerHTML;
